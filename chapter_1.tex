...
%Pada penelitian ini akan dirancang robot platform middleware ROS dengan arsitektur behavior based control. Algoritma Q-Learning hanya diterapkan pada dua prilaku yaitu menghindari rintangan, dan mencapai target. Behavior dengan tujuan berbeda dapat menimbulkan konflik yang tidak dapat diselesaikan. Oleh karena itu, dibutuhkan suatu formulasi mekanisme koordinasi yang efektif dari beberapa aktifitas robot. Kemudian juga akan ditambahkan Q learning sebagai mekanisme pembelajaran robot. Robot akan melakukan navigasi otonom untuk menghindari halangan dan menemukan target.
